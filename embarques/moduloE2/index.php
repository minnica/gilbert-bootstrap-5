						...
						<div class="col-xl-4 col-md-6 mb-4">
							<div class="card border-left-success shadow h-60 bg-light">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs fw-bold text-success text-uppercase mb-1">PESO TOTAL ENVIADO</div>
											<?php
											$sql2="SELECT IFNULL(FORMAT(SUM(peso_unitario),2),0) AS peso_enviado FROM tabla WHERE enviado = 'SI' AND ota = '3299-E2' AND cancelados != 'SI'";          
											$result2=mysqli_query($conexion,$sql2);
											while($mostrar2=mysqli_fetch_array($result2)){
												?>
												<div class="h5 mb-0 fw-bold text-gray-800"><?php echo $mostrar2['peso_enviado'] ?> Kg.</div>
											<?php } ?>
										</div>
										<div class="col-auto">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<?php                                
													$sql3="SELECT IFNULL(FORMAT(SUM(peso_unitario)*100/(SELECT SUM(peso_unitario) FROM tabla WHERE ota = '3299-E2' AND cancelados != 'SI'),2),0) AS porcentaje FROM tabla WHERE status_embarques = 'TERMINADO' AND ota = '3299-E2' AND cancelados != 'SI'";                                    
							...
							<form id="formUsuarios">    
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												...
												<select id="enviado" class="form-select">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												<label for="" class="col-form-label">FECHA REMISIÓN:</label>
												<input type="date" class="form-control" id="fecha_remision">
											</div>
										</div>
										<div class="col-lg-6">
											<div class="form-group">
												<label for="" class="col-form-label">COMENTARIOS:</label>
												<input type="text" class="form-control" id="comentarios_emb">
											</div>
										</div>  
									</div>						
								</div>
