								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<?php
											$sql2="SELECT IFNULL(FORMAT(SUM(peso_unitario),2),0) AS peso_liberado FROM tabla WHERE status_materiales = 'TERMINADO' AND ota = '3299-E2' AND cancelados != 'SI'";          
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<?php                                
													$sql3="SELECT IFNULL(FORMAT(SUM(peso_unitario)*100/(SELECT SUM(peso_unitario) FROM tabla WHERE ota = '3299-E2' AND cancelados != 'SI'),2),0) AS porcentaje FROM tabla WHERE status_materiales = 'TERMINADO' AND ota = '3299-E2' AND cancelados != 'SI'";                                    
									...
									<div class="row">                             
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<select name="" id="contratista" class="form-select" disabled="">
													<option value=""></option>            
													<?php 
									...
									<div class="row">                            
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<select name="liberado_materiales" id="liberado_materiales" class="form-select">
