								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<?php
											$sql2="SELECT IFNULL(FORMAT(SUM(peso_unitario),2),0) AS peso_liberado FROM tabla WHERE status_produccion = 'TERMINADO' AND ota = '3299-E2' AND cancelados != 'SI'";          
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<?php                                
													$sql3="SELECT IFNULL(FORMAT(SUM(peso_unitario)*100/(SELECT SUM(peso_unitario) FROM tabla WHERE ota = '3299-E2' AND cancelados != 'SI'),2),0) AS porcentaje FROM tabla WHERE status_produccion = 'TERMINADO' AND ota = '3299-E2' AND cancelados != 'SI'";                                    
				...
				<center>
					<p id="table-filter">
						...
						<select id="color_me" class="btn btn-dark">
							...
							<option class="btn materiales" value="MATERIALES">MATERIALES</option>                             
									...
									<div class="row">
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="consecutivo">                    
											</div>               
										</div> 
									</div>
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												...
												<select name="" id="folio" class="form-select" required="">
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<select name="" id="contratista" class="form-select" required="">
													<option selected>Selecciona opción</option>            
													<?php 
									...
									<div class="row">                            
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input type="date" class="form-control text-center" id="fecha_produccion">
											</div>
										</div>  
										<div class="col-lg-6">
											<div class="form-group">
												<label for="" class="col-form-label">F. TERMINO PROGRAMADA:</label>
												<input type="date" class="form-control text-center" id="fecha_termino_programada">
											</div>
										</div> 
									</div>					
								</div>
