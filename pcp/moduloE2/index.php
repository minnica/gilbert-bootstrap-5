								...
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<?php
											$sql2="SELECT IFNULL(FORMAT(SUM(peso_unitario),2),0) AS peso_liberado from tabla WHERE liberado = 'SI' AND ota = '3299-E2' AND cancelados != 'SI'";          
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<?php                                
													$sql3="SELECT IFNULL(FORMAT(SUM(peso_unitario)*100/(SELECT SUM(peso_unitario) FROM tabla WHERE ota = '3299-E2' AND cancelados != 'SI'),2),0) AS porcentaje FROM tabla WHERE liberado = 'SI' AND ota = '3299-E2' AND cancelados != 'SI'";                                    
				...
				<center>
					<p id="table-filter">
						...
						<select id="color_me" class="btn btn-dark">
							...
							<option class="btn terminado" value="LIBERADO">LIBERADO</option>   	
									...
									<div class="row">                        	
										<div class="col-lg-6">
											<div class="form-group">
												...
												<select id="liberado" class="form-select">
