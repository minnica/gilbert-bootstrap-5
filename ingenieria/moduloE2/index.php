							...
							<div class="card border-left-primary shadow h-60 bg-light">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs fw-bold text-primary text-uppercase mb-1">PESO TOTAL PRESUPUESTADO</div>
											<?php
											$sql="SELECT IFNULL(FORMAT(SUM(peso_presupuestado),2),0) AS peso_presupuestado FROM proyectos";
											$result=mysqli_query($conexion,$sql);
											while($mostrar=mysqli_fetch_array($result)){
												?>
												<div class="h5 mb-0 fw-bold text-gray-800"><?php echo $mostrar['peso_presupuestado'] ?> Kg.</div>
											<?php } ?>
										</div>
										<div class="col-auto">
						...
						<div class="col-xl-4 col-md-6 mb-4">
							<div class="card border-left-success shadow h-60 bg-light">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs fw-bold text-success text-uppercase mb-1">PESO TOTAL</div>
											<?php
											$sql2="SELECT IFNULL(FORMAT(SUM(peso_unitario),2),0) AS peso_total from tabla WHERE ota = '3299-E2' AND cancelados != 'SI'";          
											$result2=mysqli_query($conexion,$sql2);
											while($mostrar2=mysqli_fetch_array($result2)){
												?>
												<div class="h5 mb-0 fw-bold text-gray-800"><?php echo $mostrar2['peso_total'] ?> Kg.</div>
											<?php } ?>
										</div>
										<div class="col-auto">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<?php                                
													$sql3="SELECT IFNULL(FORMAT(SUM(peso_unitario)*100/(SELECT SUM(peso_presupuestado) FROM proyectos),2),0) AS porcentaje FROM tabla WHERE ota = '3299-E2' AND cancelados != 'SI'";                                    
				...
				<center>
					<p id="table-filter">
						...
						<select id="color_me" class="btn btn-dark">				 
							...
							<option class="btn proceso text-dark" value="PROCESO">PROCESO</option>            
							<option class="btn materiales" value="TERMINADO">TERMINADO</option>
							<option class="btn terminado" value="MONTADO">MONTADO</option>  
							<option class="btn btn-light" value="EN ESPERA">EN ESPERA</option> 				           
						</select>
					</p>
				</center>
							...
							<form id="formUsuarios">    
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="remision_ing">
											</div>               
										</div> 
										<div class="col-lg-6">
											<div class="form-group">
									...
									<div class="row mt-2">
										<div class="col-lg-6">
											<div class="form-group">
												<label for="liberado_ingenieria" class="form-label">LIBERADO</label>
												<select name="liberado_ingenieria" id="liberado_ingenieria" class="form-select">
													<option value=""></option>
