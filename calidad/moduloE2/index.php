						...
						<div class="col-xl-4 col-md-6 mb-4">
							<div class="card border-left-success shadow h-60 bg-light">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div class="text-xs fw-bold text-success text-uppercase mb-1">PESO TOTAL LIBERADO</div>
											<?php
											$sql2="SELECT IFNULL(FORMAT(SUM(peso_unitario),2),0) AS peso_liberado FROM tabla WHERE status_calidad = 'TERMINADO' AND ota = '3299-E2' AND cancelados != 'SI'";          
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											...
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<?php                                
													$sql3="SELECT IFNULL(FORMAT(SUM(peso_unitario)*100/(SELECT SUM(peso_unitario) FROM tabla WHERE ota = '3299-E2' AND cancelados != 'SI'),2),0) AS porcentaje FROM tabla WHERE status_calidad = 'TERMINADO' AND ota = '3299-E2' AND cancelados != 'SI'";                                    
							...
							<form id="formUsuarios">    
								<div class="modal-body">
									<div class="row d-flex justify-content-center text-center">
										...
										<div class="col-lg-6">
											<div class="form-group">
												...
												<input type="text" class="form-control text-center" id="marca" disabled="">
											</div>               
										</div>                         
									</div>
									<div class="row">
										<div class="col-lg-4">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="contratista" disabled="">
											</div>
										</div>
										<div class="col-lg-4">
											<div class="form-group">
									...
									<div class="row">  
										<div class="col-lg-2">
											<div class="form-group">
												<label for="" class="col-form-label">CONSECUTIVO:</label>
												<input type="text" class="form-control" id="consecutivo" disabled="">
											</div>
										</div> 
										<div class="col-lg-2">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-lg-2">
											<div class="form-group">
												...
												<select id="armado" class="form-select">
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<select id="soldadura" class="form-select">
													<option value="SI">SÍ</option>
													<option value="NO">NO</option>
												</select>
											</div>               
										...
										<div class="col-lg-2">
											<div class="form-group">
												...
												<select id="pintura" class="form-select">
													<option value="SI">SÍ</option>
													<option value="NO">NO</option>
												</select>
											</div>               
										...
										<div class="col-lg-2">
											<div class="form-group">
												<label for="" class="col-form-label">PENDIENTE:</label>
												<select name="pendiente_calidad" id="pendiente_calidad" class="form-select">
													<option value="SI">SÍ</option>
													<option value="NO">NO</option>
												</select>
											</div>
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="form-group text-center">
												<label class="text-center">COMENTARIOS:</label><br>
												<textarea class="form-control" id="comentarios_calidad" cols="100" rows="2"></textarea>
											</div>
										</div>
									</div>						
								</div>
